...
public class TaskServiceVariableWriterTest {
  ...
  public void testUpdateLocal() {
    CamundaBpmData.writer(taskService, TASK_ID).updateLocal(STRING, (old) -> "new value");
