...
public class BasicVariableFactoryTest {
  ...
  private final BasicVariableFactory<String> variableFactory =
      new BasicVariableFactory<>("string", String.class);
  ...
  public void shouldReturnAdapterForDelegateExecution() {
    ...
    assertThat(variableFactory.on(delegateExecution))
        .isInstanceOf(ReadWriteAdapterVariableScope.class);
  ...
  public void shouldReturnAdapterForRuntimeService() {
    ...
    assertThat(variableFactory.on(runtimeService, executionId))
        .isInstanceOf(ReadWriteAdapterRuntimeService.class);
  ...
  public void shouldReturnAdapterForTaskService() {
    ...
    assertThat(variableFactory.on(taskService, taskId))
        .isInstanceOf(ReadWriteAdapterTaskService.class);
  ...
  public void shouldReturnAdapterForCaseService() {
    ...
    assertThat(variableFactory.on(caseService, caseExecutionId))
        .isInstanceOf(ReadWriteAdapterCaseService.class);
  ...
  public void shouldReturnAdapterBuilderForRuntimeService() {
    ...
    assertThat(variableFactory.using(runtimeService))
        .isInstanceOf(BasicVariableFactory.BasicRuntimeServiceAdapterBuilder.class);
  }
  ...
  public void shouldReturnAdapterBuilderForTaskService() {
    ...
    assertThat(variableFactory.using(taskService))
        .isInstanceOf(BasicVariableFactory.BasicTaskServiceAdapterBuilder.class);
  }
  ...
  public void shouldReturnAdapterBuilderForCaseService() {
    ...
    assertThat(variableFactory.using(caseService))
        .isInstanceOf(BasicVariableFactory.BasicCaseServiceAdapterBuilder.class);
  }
}
