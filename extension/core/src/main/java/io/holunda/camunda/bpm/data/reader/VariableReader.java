...
public interface VariableReader {
  ...
  /**
   * Uses {@link ReadAdapter#getOptional()} to access variable value. If the optional is empty
   * returns <code>null</code>
   *
   * @param variableFactory the variable to read
   * @param <T> type of value
   * @return value of variable or <code>null</code> if the variable is not present or has value
   *     <code>null</code>.
   */
  ...
  /**
   * Uses {@link ReadAdapter#getLocalOptional()} to access variable value. If the optional is empty
   * returns <code>null</code>
   *
   * @param variableFactory the variable to read
   * @param <T> type of value
