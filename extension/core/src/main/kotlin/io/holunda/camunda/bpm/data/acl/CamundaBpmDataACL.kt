...
object CamundaBpmDataACL {
  ...
  /**
   * Constructs an ACL with a guard, maps variables using transformer and replaces them in a local
   * scope.
   ...
   */
  @JvmStatic
  fun guardTransformingLocalReplace(
    variableName: String,
  ...
  /**
   * Constructs an ACL with a guard, maps variables using transformer and replaces them in a global
   * scope.
   * @param variableName name of the transient variable to use.
   * @param variableMapTransformer transformer to map from external to internal representation.
   * @param variablesGuard preconditions protecting the ACL.
   */
  @JvmStatic
  fun guardTransformingGlobalReplace(
    variableName: String,
    variablesGuard: VariablesGuard,
    variableMapTransformer: VariableMapTransformer
  ) =
  ...
  /**
   * Constructs an ACL with a guard, maps variables using transformer and replaces them in a scope
   * controlled by the .
   * @param variableName name of the transient variable to use.
