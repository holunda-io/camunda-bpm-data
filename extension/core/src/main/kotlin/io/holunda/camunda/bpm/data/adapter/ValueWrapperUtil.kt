...
object ValueWrapperUtil {
  ...
  /**
   * Delivers typed value for a given type and value. Supports every type except byteArray.
   *
   ...
   * @return typed value.
   * @throws IllegalArgumentException if value and clazz are incompatible. </T>
   */
  @JvmStatic
  fun <T> getTypedValue(clazz: Class<T>, value: Any?, isTransient: Boolean): TypedValue {
    require(!(value != null && !isAssignableFrom(clazz, value.javaClass))) {
    ...
    return when (clazz) {
      ...
      Boolean::class.java,
      java.lang.Boolean::class.java -> Variables.booleanValue(value as Boolean?, isTransient)
      Int::class.java,
      java.lang.Integer::class.java -> Variables.integerValue(value as Int?, isTransient)
      Short::class.java,
      java.lang.Short::class.java -> Variables.shortValue(value as Short?, isTransient)
      Long::class.java,
      java.lang.Long::class.java -> Variables.longValue(value as Long?, isTransient)
      Date::class.java -> Variables.dateValue(value as Date?, isTransient)
      Double::class.java,
      java.lang.Double::class.java -> Variables.doubleValue(value as Double?, isTransient)
      ...
      Object::class.java ->
        Variables.objectValue(value, isTransient).create() // explicit java.lang.Object as a type
      else ->
        if (value == null) {
