...
class ListVariableFactory<T>(override val name: String, val memberClass: Class<T>) : VariableFactory<List<T>> {
  ...
  override fun on(variableScope: VariableScope): WriteAdapter<List<T>> = C7Adapters.on(this, variableScope)
  ...
  override fun from(variableScope: VariableScope): ReadAdapter<List<T>> = C7Adapters.from(this, variableScope)
  ...
  override fun on(variableMap: VariableMap): WriteAdapter<List<T>> = C7Adapters.on(this, variableMap)
  ...
  override fun from(variableMap: VariableMap): ReadAdapter<List<T>> = C7Adapters.from(this, variableMap)
  ...
  override fun on(runtimeService: RuntimeService, executionId: String): WriteAdapter<List<T>> = C7Adapters.on(this, runtimeService, executionId)
  ...
  override fun from(runtimeService: RuntimeService, executionId: String): ReadAdapter<List<T>> = C7Adapters.from(this, runtimeService, executionId)
  ...
  override fun on(taskService: TaskService, taskId: String): WriteAdapter<List<T>> = C7Adapters.on(this, taskService, taskId)
  ...
  override fun from(taskService: TaskService, taskId: String): ReadAdapter<List<T>> = C7Adapters.from(this, taskService, taskId)
  ...
  override fun on(caseService: CaseService, caseExecutionId: String): WriteAdapter<List<T>> = C7Adapters.on(this, caseService, caseExecutionId)
  ...
  override fun from(caseService: CaseService, caseExecutionId: String): ReadAdapter<List<T>> = C7Adapters.from(this, caseService, caseExecutionId)
  ...
  override fun from(lockedExternalTask: LockedExternalTask): ReadAdapter<List<T>> = C7Adapters.from(this, lockedExternalTask)
